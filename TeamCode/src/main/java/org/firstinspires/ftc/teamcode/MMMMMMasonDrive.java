...
public class MMMMMMasonDrive extends LinearOpMode {
    ...
    public void servoGo(){
        ...
        if (currentGamepad2.dpad_up && !previousGamepad2.dpad_up){
            rClaw.setPosition(0.33); // r claw bigger closer
            lClaw.setPosition(0.07); // l claw smaller closer
        }
        if (currentGamepad2.dpad_down && !previousGamepad2.dpad_down){
            rClaw.setPosition(0.12); // r claw smaller further
            lClaw.setPosition(0.23); // l claw bigger further
        }
         */
    }
